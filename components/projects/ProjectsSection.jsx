    ...
    >
      ...
      <div className="flex lg:flex-row flex-col w-full h-full justify-center items-center ">
        ...
        <div className="flex flex-col md:gap-4 gap-2 xl:w-5/6 lg:w-4/5 w-full md:mt-0 mt-5 lg:mt-0 lg:px-0 px-4">
          ...
          >
            {/* tech stack */}
            <div className="flex flex-col gap-3 md:w-1/2 w-full bg-[#171717] rounded-[36px] xl:p-5 lg:p-4 p-5">
            ...
            <div
              id="journey"
              className="flex flex-col md:gap-3 gap-1 md:w-1/2 w-full h-auto bg-[#171717] p-5 rounded-[36px] drop-shadow-lg"
            >
